...
volatile int16 ECPULSE1 = 0;          // 速度全局变量
volatile int16 ECPULSE2 = 0;          // 速度全局变量
volatile int32 RAllPulse = 0;          // 速度全局变量



int16 dutty =3500,encoder1;//临时
...
IFX_INTERRUPT(cc60_pit_ch0_isr, 0, CCU6_0_CH0_ISR_PRIORITY)
{
	...
	encoder1 = gpt12_get(GPT12_T4);//1000pwm 310
    gpt12_clear(GPT12_T4);
//    lcd_showuint16(0,0,encoder1);

     dutty = -500;//SBB_Get_MotorPI (encoder1 , 400 );
//      lcd_showuint16(0,0,dutty);
